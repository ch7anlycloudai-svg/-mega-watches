    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <Link
          ...
          className="bg-gradient-to-l from-gold to-gold-light text-black font-bold px-6 py-2.5 rounded-lg hover:opacity-90 transition-opacity flex items-center gap-2"
        >
