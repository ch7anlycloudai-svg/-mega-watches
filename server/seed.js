...
const products = [
  {
    name: "ساعة رولكس ديت جست", nameEn: "Rolex Datejust", brand: "رولكس", category: "فاخرة",
    price: 450000, oldPrice: 520000,
  ...
  {
    name: "ساعة أوميغا سيماستر", nameEn: "Omega Seamaster", brand: "أوميغا", category: "فاخرة",
  ...
  {
    name: "ساعة كارتييه تانك", nameEn: "Cartier Tank", brand: "كارتييه", category: "فاخرة",
    price: 380000, oldPrice: 420000,
  ...
  {
    name: "ساعة تاغ هوير كاريرا", nameEn: "TAG Heuer Carrera", brand: "تاغ هوير", category: "رياضية",
  ...
  {
    name: "ساعة كاسيو جي شوك", nameEn: "Casio G-Shock", brand: "كاسيو", category: "رياضية",
  ...
  {
    name: "ساعة سيكو بريساج", nameEn: "Seiko Presage", brand: "سيكو", category: "كلاسيكية",
  ...
  {
    name: "ساعة تيسو جنتلمان", nameEn: "Tissot Gentleman", brand: "تيسو", category: "كلاسيكية",
  ...
  {
    name: "ساعة أبل ألترا 2", nameEn: "Apple Watch Ultra 2", brand: "أبل", category: "ذكية",
  ...
  {
    name: "ساعة سامسونج جالاكسي 6", nameEn: "Samsung Galaxy Watch 6", brand: "سامسونج", category: "ذكية",
  ...
  {
    name: "ساعة هوبلو بيغ بانغ", nameEn: "Hublot Big Bang", brand: "هوبلو", category: "فاخرة",
    price: 620000, oldPrice: null,
  ...
  {
    name: "ساعة فوسيل جرانت", nameEn: "Fossil Grant", brand: "فوسيل", category: "كلاسيكية",
    price: 7500, oldPrice: 9500,
  ...
  {
    name: "ساعة غارمين فينيكس 7", nameEn: "Garmin Fenix 7", brand: "غارمين", category: "رياضية",
...
const seedOrders = [
  { customer: "محمد أحمد", phone: "+222 36 12 34 56", email: "mohamed@email.com", city: "نواكشوط", address: "تفرغ زينه", total: 450000, status: "مكتمل",
  ...
  { customer: "أحمد محمود", phone: "+222 46 78 90 12", email: "ahmed@email.com", city: "نواكشوط", address: "الميناء", total: 475000, status: "قيد التوصيل",
    items: [
  ...
  { customer: "فاطمة بنت سيدي", phone: "+222 22 33 44 55", email: "fatima@email.com", city: "نواذيبو", address: "المركز", total: 620000, status: "معلق",
  ...
  { customer: "عبد الله ولد محمد", phone: "+222 41 22 33 44", email: "abdallah@email.com", city: "نواكشوط", address: "كرفور", total: 380000, status: "معلق",
    items: [{ name: "ساعة كارتييه تانك", price: 380000, quantity: 1, image: "https://images.unsplash.com/photo-1548171916-c8d1f4c993c4?w=600" }] },
  { customer: "مريم بنت أحمد", phone: "+222 33 44 55 66", email: "mariem@email.com", city: "نواكشوط", address: "السبخة", total: 22000, status: "مكتمل",
...
async function seed() {
  try {
    ...
    // Seed admin
    await Admin.create({ name: "المدير", email: "admin@watches.mr", password: "admin123" });
